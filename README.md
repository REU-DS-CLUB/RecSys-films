...
Запуск файлов .ipynb осуществляется в Jupyter Notebook или Google Collab, данные подтягиваются из облачного хранилища, так то дорстаточно просто запустить код.
